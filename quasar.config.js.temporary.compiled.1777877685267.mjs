...
var __quasar_inject_dirname__ = "C:\\Users\\meida\\Desktop\\github-woo-quasar-pwa-app\\new-project-clone\\wc-pwa-shop-v2-new-10";
  ...
  return {
    ...
    htmlVariables: {
      csp: `
        ...
        connect-src 'self' ${import.meta.env.VITE_API_BASE};
        font-src 'self' https://fonts.gstatic.com;
        frame-src https://accounts.google.com;
  `,
      head: `
    <link rel="preconnect" href="${import.meta.env.VITE_API_BASE}" crossorigin>
    <link rel="dns-prefetch" href="${import.meta.env.VITE_API_BASE}">
     `
    },
    htmlVariablesRender: {
    ...
    build: {
      ...
      cssCodeSplit: true,
      preloadChunks: false,
      // ensures critical JS is preloaded
      polyfills: {
        coreJs: false
        // PWA modern browsers don't need heavy polyfills
      },
      vitePlugins: [
        ["vite-plugin-checker", {
          eslint: {
      ...
      extendViteConf(viteConf, { isClient }) {
        ...
        if (isClient) {
          viteConf.build.rollupOptions = {
            ...
            output: {
              ...viteConf.build.rollupOptions?.output,
              manualChunks(id) {
                if (id.includes("quasar/src/components/scroll-observer") || id.includes("quasar/src/components/resize-observer") || id.includes("quasar/src/directives/touch-pan") || id.includes("quasar/src/directives/touch-hold") || id.includes("quasar/src/utils/format")) {
        ...
        viteConf.resolve.alias = {
          "src/boot/push.js": isCapacitor ? path.resolve(__quasar_inject_dirname__, "src/boot/push.native.js") : path.resolve(__quasar_inject_dirname__, "src/boot/push.web.js"),
          ...viteConf.resolve.alias
        };
      }
    },
    ...
    pwa: {
      ...
      injectManifest: {
        ...
        // exclude netlify.toml just in case
      },
      //useCredentialsForManifestTag: false,
      manifest: {
        name: "My Shop App",
